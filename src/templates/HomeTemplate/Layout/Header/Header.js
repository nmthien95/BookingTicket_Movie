  ...
  const renderLogin = () => {
    if (_.isEmpty(userLogin)) {
      return (
        <Fragment>
          ...
          <button className="self-center p-1  ml-2 text-center bg-transparent">
            <NavLink to="/register" rel="noopener noreferrer" className="flex items-center px-4 font-bold text-md text-slate-500      hover:text-slate-900">
      ...
      return (
        <Fragment>
          <button className="self-center p-1  border-r-2  border-slate-400 text-center">
            <NavLink to="/profile" rel="noopener noreferrer" className="flex items-center px-4 font-bold  text-md  text-slate-500 hover:text-slate-900 ">
      ...
      >
        <div className="container flex justify-between h-16 py-1 mx-auto">
          <NavLink
            ...
            className="flex items-center justify-center hover:bg-gradient-to-r hover:from-teal-400 hover:to-lime-400 hover:bg-clip-text hover:text-transparent font-extrabold text-transparent  text-3xl   bg-clip-text bg-gradient-to-r from-teal-400 to-lime-400 "
          >
            Movie Start
          </NavLink>
          <ul className="items-stretch hidden space-x-3 lg:flex mb-0">
            <li className="flex ">
              <a href="#lichChieu" className="  text-theme-hover text-header" activeClassName="text-header-classActive">
                Lịch chiếu
                <div className="text-header-active btn-theme"></div>
              </a>
            </li>
            <li className="flex">
              <a href="#cumRap" className="text-theme-hover text-header" activeClassName="text-header-classActive">
                Cụm Rạp
                <div className="text-header-active btn-theme"></div>
              </a>
            </li>
            <li className="flex">
              <a href="#ungDung" className="text-theme-hover text-header" activeClassName="text-header-classActive	">
                Ứng dụng
                <div className="text-header-active btn-theme"></div>
              </a>
            </li>
